[Home](../../) | [Projects](../../projects) | [Notes](../) > <a href="./">MCU Peripheral Drivers</a> > Using `printf()` with Serial Wire Viewer (SWV)
...
<img src="./img/printf-using-serial-wire-viewer.png" alt="printf-using-serial-wire-viewer" width="750">
